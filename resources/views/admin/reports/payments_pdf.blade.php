...
<body>
    ...
    <div class="header">
        ...
        <div class="header-bottom">
            ...
            <div class="header-bottom-right">
                <span>Generated: {{ now('Asia/Manila')->format('F d, Y') }}</span>
                <span>Time: {{ now('Asia/Manila')->format('h:i A') }}</span>
    ...
    @php
        ...
        // Group by LOCAL date (Asia/Manila)
        $groupedPayments = $payments->groupBy(function ($payment) {
            $date = $payment->payment_date ?? $payment->created_at;
            return $date->setTimezone('Asia/Manila')->format('Y-m-d');
        })->sortKeys();
    @endphp
    ...
    @foreach($groupedPayments as $localDate => $dayPayments)
        @php
            $dayTotal      = $dayPayments->sum('total_amount');
            $grandTotal   += $dayTotal;
            // Use local date for display (already in Asia/Manila)
            $formattedDate = \Carbon\Carbon::parse($localDate)->setTimezone('Asia/Manila')->format('F d, Y - l');
        @endphp
    ...
    {{-- ── FOOTER ── --}}
    <div class="footer">
        This document is system-generated by <strong>UniPay</strong> &mdash; {{ now('Asia/Manila')->format('F d, Y \a\t h:i A') }}.
