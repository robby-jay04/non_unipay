...
<div class="form-card">
    ...
    <form method="POST" action="{{ route('admin.superadmin.admins.store') }}">
        @csrf
        ...
        <div class="row g-4">
            <div class="col-12 col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. Maria Santos" required autofocus>
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="mb-3">
                    <label class="form-label">Password</label>
                        ...
                        <input type="password" id="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Min. 8 chars, upper + lower + number" required>
